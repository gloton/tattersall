		...
		<div class="wrap">
			<div id="wrap_remates" style="height: 700px;">
				<div id="tabs-mev" class="tabBox" style="clear:both;">
					<div class="tabArea">
						<a id="pag_remates" class="tab" href="../tabs/tabs-paginas/tab-remate-propiedad.html" target="tabIframe2" style="margin-left: 10px;">Remates</a>
						<a id="pag_venta_directa" class="tab" href="../tabs/tabs-paginas/tab-ficha-frutillar-alto.html" target="tabIframe2">Venta Directa</a>
						<a id="pag_arriendos" class="tab" href="../tabs/tabs-paginas/tab-propiedades-arriendos.html" target="tabIframe2">Arriendos</a>
					</div>
					<div class="tabMain">
					<div class="tabIframeWrapper">
						<iframe class="tabContent" name="tabIframe2" src="../tabs/tabs-paginas/tab-remate-propiedad.html" style="height: 1450px;" marginheight="8" marginwidth="8" frameborder="0"></iframe>
					</div>
					</div>
				</div>
				<div class="col_right">
